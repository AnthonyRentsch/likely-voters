...
![](cutoff_models_files/figure-html/unnamed-chunk-4-1.png)<!-- -->
...
![](cutoff_models_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
...
![](cutoff_models_files/figure-html/unnamed-chunk-9-1.png)<!-- -->

![](cutoff_models_files/figure-html/unnamed-chunk-10-1.png)<!-- -->

![](cutoff_models_files/figure-html/unnamed-chunk-11-1.png)<!-- -->
...
![](cutoff_models_files/figure-html/unnamed-chunk-14-1.png)<!-- -->
...
![](cutoff_models_files/figure-html/unnamed-chunk-16-1.png)<!-- -->

## Election predictions

![](cutoff_models_files/figure-html/unnamed-chunk-17-1.png)<!-- -->
...
![](cutoff_models_files/figure-html/unnamed-chunk-20-1.png)<!-- -->

![](cutoff_models_files/figure-html/unnamed-chunk-21-1.png)<!-- -->
...
![](cutoff_models_files/figure-html/unnamed-chunk-22-1.png)<!-- -->
...
income_new2               -0.174       0.085      -2.046     0.041
income_new3               -0.084       0.096      -0.875     0.381
income_new4               -0.264       0.121      -2.176     0.030
partisan_strength2         0.018       0.072       0.255     0.799
partisan_strength3        -0.011       0.078      -0.146     0.884
partisan_strength4        -0.325       0.095      -3.417     0.001
...
marital_status2            0.206       0.084       2.449     0.014
marital_status3           -0.118       0.084      -1.409     0.159
residential_mobility       0.001       0.008       0.146     0.884
watch_news2                0.007       0.091       0.076     0.940
watch_news3               -0.011       0.072      -0.148     0.882
read_paper2                0.244       0.071       3.423     0.001
read_paper3               -0.168       0.075      -2.255     0.024

### Individual-level turnout

![](cutoff_models_files/figure-html/unnamed-chunk-26-1.png)<!-- -->

![](cutoff_models_files/figure-html/unnamed-chunk-27-1.png)<!-- -->
...
![](cutoff_models_files/figure-html/unnamed-chunk-28-1.png)<!-- -->
...
![](cutoff_models_files/figure-html/unnamed-chunk-31-1.png)<!-- -->


![](cutoff_models_files/figure-html/unnamed-chunk-32-1.png)<!-- -->
       
![](cutoff_models_files/figure-html/unnamed-chunk-33-1.png)<!-- -->
...
![](cutoff_models_files/figure-html/unnamed-chunk-36-1.png)<!-- -->

![](cutoff_models_files/figure-html/unnamed-chunk-37-1.png)<!-- -->


### Election predictions

![](cutoff_models_files/figure-html/unnamed-chunk-38-1.png)<!-- -->
